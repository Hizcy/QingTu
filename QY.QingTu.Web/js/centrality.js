$(document).ready(function(){
	...
	$(function () {
            if ((screen.width == 1920) && (screen.height == 1080)) {
                $(".BC_infotab").css("margin-left","14%");
                $("#dpmc").css("width","148")
                $("#qkyhk").css("width","18%")
            } else {
                $(".BC_infotab").css("margin-left","8%");
                $("#dpmc").css("width","140")
            } 
        });
        $(function () {
            if ((screen.width == 1366 && screen.height == 768) || (screen.width == 1400 && screen.height == 1050) || (screen.width == 1440 && screen.height == 900)) {
                $("#qkyhk").css("width","26%")
            } else{
            		$("#qkyhk").css("width","22%")
            }
	...
	//商户资料编辑按钮显示隐藏
	$(".infoBox_on").hover(function(){
		$(".edit").show();
	})
	$(".infoBox_on").mouseleave(function(){
		$(".edit").hide();
	})
	
	//环形图
	var a = $('.infotab_blue span').html(),
		b = $('.infotab_green span').html(),
		s = a*1+b*1,
		t = (Number(s)).toFixed(2);
	$(function(){
		$("#doughnutChart").drawDoughnutChart([
		    { title: "可用金额", value : a*1,  color: "#f96042" },
		    { title: "待用金额", value:  b*1,   color: "#ffb04a" },
	    ]);
	});
	
	$(".infotab_red p span").html(t);
...
(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    if(animationDecimal == 0.9999998780673678){return false;};
    $summaryNumber
